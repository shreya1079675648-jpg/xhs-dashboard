...
// Constants
import { ACCENT, BG, CARD, BORDER, MUTED, PILLARS, STATUSES, TYPE_COLOR, STATUS_DOT, WEEKDAYS, MONTH_NAMES, CAL_TYPE_GROUPS } from "./constants/config";
import { ST, PRIORITY, JUDGMENT } from "./constants/review";
// Utils
import { uid, countChars, hasConflict, fmtRate, fmtNum, devPct } from "./utils/format";
import { judgePost, statusColor, generateCover, generateBody, compressBody, addEmotion, addEnding, titleSuggestions } from "./utils/content";
import { groupNotesByDate, buildCalendarCells, formatDateKey, getTodayStr, getMonthNotes, getCalDisplayDate } from "./utils/calendar";
import { computeStatusTags } from "./utils/review";
// Legacy IDB (kept for cleanup compat)
import { IDB_NAME, IDB_STORE, openImgDB, idbSaveImages, idbLoadAllImages, idbDeleteImages, idbSaveCover } from "./lib/idb";
// Seed data + reference constants
import { SEED_TOPICS, SEED_COMMENTS, SEED_CAL_NOTES, ACCOUNT_PROFILE_DATA, PATTERN_REPORT } from "./constants/seed";

/* ════════════════════════════ SEED DATA (moved to ./constants/seed.js) ════ */
